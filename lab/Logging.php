...
<body>
    ...
    <form action="Logging.php" method="POST">
        ...
        <select name="student_id" id="student_id" required>
            ...
            <option value="ST125">ST125</option>
            <option value="ST126">ST126</option>
            <option value="ST126">ST127</option>
        </select>
        ...
        <select name="class_id" id="class_id" required>
            ...
            <option value="CS102">CS103</option>
            <option value="CS102">CS104</option>
            <option value="CS102">CS105</option>
        </select>
